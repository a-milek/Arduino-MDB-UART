...
{
	eeprom_write_block((void*)&CoinChangerOptions, (void*)&nv_CoinChangerOptions, 5);
...
void ResetCoinChangerOptions()
{
	...
	eeprom_write_block((void*)&tmp, (void*)&nv_CoinChangerOptions, 5);
	eeprom_read_block((void*)&CoinChangerOptions, (const void*)&nv_CoinChangerOptions, 5);
...
void WriteBVOptions()
{
	eeprom_write_block((void*)&BillValidatorOptions, (void*)&nv_BillValidatorOptions, 11);
...
void ResetBVOptions()
{
	uint8_t tmp[9] = {0xff,0xff,0xff,0xff,0x00,0x00,0xff,0xff,1};
	eeprom_write_block((void*)&tmp, (void*)&nv_BillValidatorOptions, 11);
...
{
	eeprom_write_block((void*)&CoinHopperOptions, (void*)&nv_CoinHopperOptions, 4);
